      ...
      >
        <div className="px-2 sm:px-4 md:px-6 grid grid-cols-1 md:grid-cols-6 grid-rows-auto justify-items-start">
          <h1
            ...
            className="col-start-1 md:col-end-4 text-left font-title text-6xl md:text-6xl lg:text-8xl mb-4 opacity-0 transform transition duration-1000"
          >
            <p className="text-c4p">TRANSFORM A LIFE</p>
            <p className="text-white">WITH TECHNOLOGY</p>
          </h1>
          <div
            ref={(el) => (animatedElements.current[1] = el)}
            className="col-start-1 md:col-end-4 opacity-0 transform transition duration-1000"
          >
            <div className="flex flex-col md:flex-row">
              <Link
                to="/ewaste"
