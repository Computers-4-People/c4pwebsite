export const shieldFaqs = [
  ...
  {
    question: "Is the device locked or restricted?",
    answer:
      "The Shield 5G Home Device is fully unlocked and portable. It works with most SIM cards and supports 5G, 4G, and 3G networks. The Shield 5G Hotspot, however, is locked to work only with our Shield Internet plan.",
  },
  {
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <a href="/shield-auth" className="text-blue-500 underline">
          subscriber portal
        </a>
